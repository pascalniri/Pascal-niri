      ...
      <div>
        ...
        <div className="p-[40px] flex flex-col justify-center mt-[30px]">
          ...
          <div className="mt-[30px]">
            ...
            Fadga Dahaba</h1>
            <p className="text-[12px] font-poppins font-light text-[#d4d4d4] ml-[16px]">That's a great experience my guy whoever wanna invest him or herself in UI/UX design should have 👌✋</p>
          </div>

          <div className="mt-[30px]">
            <form className="w-full">
              <input type="text" placeholder="Enter your name" className="w-full bg-[#2C1250] px-[20px] py-[10px] rounded-[7px] text-[12px] font-poppins font-light text-[#d4d4d4] outline-none border border-[#7127BA]" />
              <textarea type="text"  placeholder="Your comment" className="w-full h-[200px] bg-[#2C1250] px-[20px] py-[10px] rounded-[7px] text-[12px] font-poppins font-light text-[#d4d4d4] outline-none border border-[#7127BA] mt-[20px]"  />
